...
const Title = ({title}) => (  // 模块标题
  <div className="page06-title">
    <span className="page06-title-line"></span>
    <span className="page06-title-text">{title}</span>
  </div>
);

const Avatar = ({avatar, text}) => (
  <div className="page06-avatar">
    <span className="page06-avatar-image"></span>
    <img src={avatar} alt={text} />
    <span className="page06-avatar-text">{text}</span>
  </div>
);
