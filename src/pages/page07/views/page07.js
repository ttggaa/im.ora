...
const Title = ({title}) => (  // 模块标题
  <div className="page07-title">
    <span className="page07-title-line"></span>
    <span className="page07-title-text">{title}</span>
  </div>
);

const Avatar = ({avatar, text}) => (
  <div className="page07-avatar">
    <span className="page07-avatar-image"></span>
    <img src={avatar} alt={text} />
    <span className="page07-avatar-text">{text}</span>
  </div>
);
