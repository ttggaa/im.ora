...
const CompanyIntro = () => (  // 公司简介
  <div className="index-intro">
    ...
    <p className="text-justify text-indent">橘子情感，自创办以来，一直引领着整个行业的进步和发展。为了让广大用户，学会更好的爱与被爱的能力让用户在爱情中更加有尊严，更加从容，更加自由。橘子情感汇聚了国内知名两陕情感咨询师、婚恋家庭咨询师、资深清感挽回师、心理学专家等用最专业的师资团队，打造全国最专业的情感咨询培训机构。</p>

    <p className="text-justify text-indent">橘子情感的创办初衷，是针对解决广大民众的清感挽回、婚姻修复等社会问题但逐渐发现，中国在情感教育方面是完全缺失的。现在，我们要解决的，不仅仅是简单的情感问题更是整个时代的情感教育缺失。</p>
  </div>
);
