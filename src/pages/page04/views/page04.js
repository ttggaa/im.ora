...
const Title = ({title}) => (  // 模块标题
  <div className="page04-title">
    ...
    <span className="page04-title-text">{title}</span>
  </div>
);

const Avatar = ({avatar, text}) => (
  <div className="page04-avatar">
    <span className="page04-avatar-image"></span>
    <img src={avatar} alt={text} />
    <span className="page04-avatar-text">{text}</span>
  </div>
);
