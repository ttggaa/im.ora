...
const Title = ({title}) => (  // 模块标题
  <div className="page08-title">
    <span className="page08-title-line"></span>
    <span className="page08-title-text">{title}</span>
  </div>
);

const Avatar = ({avatar, text}) => (
  <div className="page08-avatar">
    <span className="page08-avatar-image"></span>
    <img src={avatar} alt={text} />
    <span className="page08-avatar-text">{text}</span>
  </div>
);
